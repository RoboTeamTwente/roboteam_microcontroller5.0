...
#define WIRELESS_CHANNEL_YELLOW_ROBOT_TO_BASESTATION -5.5 //-10  
#define WIRELESS_CHANNEL_BLUE_ROBOT_TO_BASESTATION   -7   //-11.5
#define WIRELESS_CHANNEL_YELLOW_BASESTATION_TO_ROBOT -8.5 //-13  
#define WIRELESS_CHANNEL_BLUE_BASESTATION_TO_ROBOT   -10  //-14.5
